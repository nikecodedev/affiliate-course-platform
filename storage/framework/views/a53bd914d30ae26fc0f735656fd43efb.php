            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="btn-group" role="group">
                            <button type="button" class="btn <?php echo e(!request()->hasAny(['type', 'status']) ? 'btn-primary' : 'btn-outline-primary'); ?>" onclick="quickFilter('all')">
                                <i class="bi bi-people me-1"></i>All Users
                            </button>
                            <button type="button" class="btn <?php echo e(request('type') == 'affiliates' ? 'btn-success' : 'btn-outline-success'); ?>" onclick="quickFilter('affiliates')">
                                <i class="bi bi-person-check me-1"></i>Affiliates
                            </button>
                            <button type="button" class="btn <?php echo e(request('type') == 'customers' ? 'btn-info' : 'btn-outline-info'); ?>" onclick="quickFilter('customers')">
                                <i class="bi bi-person me-1"></i>Customers
                            </button>
                            <button type="button" class="btn <?php echo e(request('status') == 'active' ? 'btn-success' : 'btn-outline-success'); ?>" onclick="quickFilter('active')">
                                <i class="bi bi-check-circle me-1"></i>Active
                            </button>
                            <button type="button" class="btn <?php echo e(request('status') == 'inactive' ? 'btn-warning' : 'btn-outline-warning'); ?>" onclick="quickFilter('inactive')">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK-Station\freelance\workana\affiliate\resources\views/admin/users/index.blade.php ENDPATH**/ ?>