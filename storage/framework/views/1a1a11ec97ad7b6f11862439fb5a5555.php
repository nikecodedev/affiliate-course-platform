...
<?php $__env->startSection('page-title', 'Invoices & Billing'); ?>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="stat-number"><?php echo e($client->invoices()->count()); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="stat-number"><?php echo e($client->invoices()->active()->count()); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="stat-number"><?php echo e($client->invoices()->where('status', 'pending')->count()); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="stat-number">R$ <?php echo e(number_format($client->invoices()->where('status', 'paid')->sum('amount'), 2, ',', '.')); ?></div>
                    </div>
                    <div class="col-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="<?php echo e(route('client.support.create')); ?>" class="btn btn-outline-info">
            ...
            <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <code class="text-primary">#<?php echo e($invoice->id); ?></code>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="fw-bold"><?php echo e($invoice->plan->name ?? 'No Plan'); ?></span>
                                            <small class="text-muted"><?php echo e($invoice->plan->description ?? ''); ?></small>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="fw-bold">R$ <?php echo e(number_format($invoice->amount, 2, ',', '.')); ?></span>
                                    </td>
                                    <td>
                                        <span class="badge bg-<?php echo e($invoice->status === 'active' ? 'success' : ($invoice->status === 'pending' ? 'warning' : ($invoice->status === 'paid' ? 'info' : 'danger'))); ?>">
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span><?php echo e($invoice->created_at->format('d/m/Y')); ?></span>
                                            <small class="text-muted"><?php echo e($invoice->created_at->format('H:i')); ?></small>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span><?php echo e($invoice->expires_at ? $invoice->expires_at->format('d/m/Y') : 'N/A'); ?></span>
                                            <small class="text-muted"><?php echo e($invoice->expires_at ? $invoice->expires_at->format('H:i') : ''); ?></small>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(route('client.financial.invoice.show', $invoice)); ?>" 
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-warning" 
                                                    onclick="uploadReceipt(<?php echo e($invoice->id); ?>)"
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <div>
                            <p class="text-muted mb-0">
                                ...
                                of <?php echo e($invoices->total()); ?> results
                            </p>
                        </div>
                        <div>
                ...
                <?php else: ?>
                    <div class="text-center py-5">
                        ...
                        <a href="<?php echo e(route('client.financial.index')); ?>" class="btn btn-primary">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="invoice_id" id="invoice_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $client->invoices()->where('status', 'pending')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($invoice->id); ?>">
                                    Invoice #<?php echo e($invoice->id); ?> - R$ <?php echo e(number_format($invoice->amount, 2, ',', '.')); ?>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK-Station\freelance\workana\affiliate\resources\views/client/financial/invoices.blade.php ENDPATH**/ ?>