...
@section('title', 'Edit Bonus Configuration')
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Edit Bonus Configuration: {{ $globalBonusConfiguration->name }}
                    </h3>
                ...
                <form action="{{ route('admin.bonus-configurations.global.update', $globalBonusConfiguration) }}" method="POST" id="bonusForm">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                           id="name" name="name" value="{{ old('name', $globalBonusConfiguration->name) }}" 
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('type') is-invalid @enderror" 
                                        ...
                                        @foreach($bonusTypes as $key => $label)
                                            <option value="{{ $key }}" {{ old('type', $globalBonusConfiguration->type) == $key ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              placeholder="Optional description for this configuration">{{ old('description', $globalBonusConfiguration->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('max_depth') is-invalid @enderror" 
                                           id="max_depth" name="max_depth" value="{{ old('max_depth', $globalBonusConfiguration->max_depth) }}" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('max_width') is-invalid @enderror" 
                                           id="max_width" name="max_width" value="{{ old('max_width', $globalBonusConfiguration->max_width) }}" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('min_sale_amount') is-invalid @enderror" 
                                           id="min_sale_amount" name="min_sale_amount" value="{{ old('min_sale_amount', $globalBonusConfiguration->min_sale_amount) }}" 
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                               value="1" {{ old('is_active', $globalBonusConfiguration->is_active) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_percentage" name="is_percentage" 
                                               value="1" {{ old('is_percentage', $globalBonusConfiguration->is_percentage) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="requires_active_invoice" name="requires_active_invoice" 
                                               value="1" {{ old('requires_active_invoice', $globalBonusConfiguration->requires_active_invoice) ? 'checked' : '' }}>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12">
                                <div id="levels-container">
                                    @foreach($globalBonusConfiguration->bonusLevels as $index => $level)
                                        <div class="card mb-3 level-item" data-level="{{ $level->level }}">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-1">
                                                        <label class="form-label">Level</label>
                                                        <input type="number" class="form-control" name="levels[{{ $index }}][level]" 
                                                               value="{{ $level->level }}" min="1" max="20" required readonly>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="form-label">Amount</label>
                                                        <input type="number" class="form-control" name="levels[{{ $index }}][amount]" 
                                                               value="{{ $level->amount }}" step="0.01" min="0" required placeholder="0.00">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="form-label">Type</label>
                                                        <select class="form-control" name="levels[{{ $index }}][is_percentage]">
                                                            <option value="0" {{ !$level->is_percentage ? 'selected' : '' }}>Fixed Amount</option>
                                                            <option value="1" {{ $level->is_percentage ? 'selected' : '' }}>Percentage</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label class="form-label">Description</label>
                                                        <input type="text" class="form-control" name="levels[{{ $index }}][description]" 
                                                               value="{{ $level->description }}" placeholder="Optional description">
                                                    </div>
                                                    <div class="col-md-2">
...
document.addEventListener('DOMContentLoaded', function() {
    let levelCount = {{ $globalBonusConfiguration->bonusLevels->count() }};
    ...
    // Initialize max width field visibility
    if (typeSelect.value === 'forced_matrix') {
        document.getElementById('max_width').closest('.form-group').style.display = 'block';
    } else {
        document.getElementById('max_width').closest('.form-group').style.display = 'none';
    }
