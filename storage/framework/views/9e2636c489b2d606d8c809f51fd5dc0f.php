...
<?php $__env->startSection('page-title', 'Support Center'); ?>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="stat-number"><?php echo e($client->supportTickets()->count()); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="stat-number"><?php echo e($client->supportTickets()->where('status', 'open')->count()); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="stat-number"><?php echo e($client->supportTickets()->where('status', 'closed')->count()); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="stat-number"><?php echo e($avgResponseTime ?? '0'); ?>h</div>
                    </div>
                    <div class="col-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="<?php echo e(route('client.support.faq')); ?>" class="btn btn-outline-primary">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <code class="text-primary">#<?php echo e($ticket->id); ?></code>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="fw-bold"><?php echo e(Str::limit($ticket->subject, 40)); ?></span>
                                            <small class="text-muted"><?php echo e(Str::limit($ticket->description, 60)); ?></small>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="badge bg-secondary"><?php echo e($ticket->category ?? 'General'); ?></span>
                                    </td>
                                    <td>
                                        <span class="badge bg-<?php echo e($ticket->priority === 'high' ? 'danger' : ($ticket->priority === 'medium' ? 'warning' : 'info')); ?>">
                                            <?php echo e(ucfirst($ticket->priority ?? 'low')); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge bg-<?php echo e($ticket->status === 'open' ? 'warning' : ($ticket->status === 'closed' ? 'success' : 'info')); ?>">
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            ...
                                            <small class="text-muted"><?php echo e($ticket->created_at->format('H:i')); ?></small>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span><?php echo e($ticket->updated_at->format('d/m/Y')); ?></span>
                                            <small class="text-muted"><?php echo e($ticket->updated_at->format('H:i')); ?></small>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(route('client.support.ticket.show', $ticket)); ?>" 
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-success" 
                                                    onclick="closeTicket(<?php echo e($ticket->id); ?>)"
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <div>
                            <p class="text-muted mb-0">
                                Showing <?php echo e($tickets->firstItem()); ?> to <?php echo e($tickets->lastItem()); ?> 
                                of <?php echo e($tickets->total()); ?> results
                            </p>
                        </div>
                        <div>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK-Station\freelance\workana\affiliate\resources\views/client/support/index.blade.php ENDPATH**/ ?>