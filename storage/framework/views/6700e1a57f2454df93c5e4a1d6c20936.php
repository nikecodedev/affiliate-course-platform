...
<?php $__env->startSection('title', 'Capture Sites'); ?>
<?php $__env->startSection('page-title', 'Capture Sites'); ?>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="mainCaptureUrl" 
                                               value="<?php echo e(route('client.capture.main', ['code' => auth('client')->user()->id])); ?>" readonly>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <small class="text-muted">
                                            <strong>Visits:</strong> <?php echo e($stats['main_visits'] ?? 0); ?>

                                        </small>
                                    </div>
                                    <div class="col-md-6">
                                        <small class="text-muted">
                                            <strong>Conversions:</strong> <?php echo e($stats['main_conversions'] ?? 0); ?>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <a href="<?php echo e(route('client.capture.main', ['code' => auth('client')->user()->id])); ?>" 
                        ...
                        <div class="card border-secondary">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="secondaryCaptureUrl" 
                                               value="<?php echo e(route('client.capture.secondary', ['code' => auth('client')->user()->id])); ?>" readonly>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <small class="text-muted">
                                            <strong>Visits:</strong> <?php echo e($stats['secondary_visits'] ?? 0); ?>

                                        </small>
                                    </div>
                                    <div class="col-md-6">
                                        <small class="text-muted">
                                            <strong>Conversions:</strong> <?php echo e($stats['secondary_conversions'] ?? 0); ?>

                                        </small>
                                    </div>
                                </div>
                                <div class="mt-3">
                                    <a href="<?php echo e(route('client.capture.secondary', ['code' => auth('client')->user()->id])); ?>" 
                        ...
                        <div class="card border-info">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="mobileCaptureUrl" 
                                               value="<?php echo e(route('client.capture.main', ['code' => auth('client')->user()->id, 'mobile' => 1])); ?>" readonly>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <small class="text-muted">
                                            <strong>Visits:</strong> <?php echo e($stats['mobile_visits'] ?? 0); ?>

                                        </small>
                                    </div>
                                    <div class="col-md-6">
                                        <small class="text-muted">
                                            <strong>Conversions:</strong> <?php echo e($stats['mobile_conversions'] ?? 0); ?>

                                        </small>
                                    </div>
                                </div>
                                <div class="mt-3">
                                    <a href="<?php echo e(route('client.capture.main', ['code' => auth('client')->user()->id, 'mobile' => 1])); ?>" 
                ...
                <div class="row">
                    <div class="col-md-3 text-center">
                        <div class="border-end">
                            <h4 class="text-primary"><?php echo e($stats['total_visits'] ?? 0); ?></h4>
                            <small class="text-muted">Total Visits</small>
                        </div>
                    </div>
                    <div class="col-md-3 text-center">
                        <div class="border-end">
                            <h4 class="text-success"><?php echo e($stats['total_conversions'] ?? 0); ?></h4>
                            <small class="text-muted">Total Conversions</small>
                        </div>
                    </div>
                    <div class="col-md-3 text-center">
                        <div class="border-end">
                            <h4 class="text-warning"><?php echo e(number_format($stats['conversion_rate'] ?? 0, 1)); ?>%</h4>
                            <small class="text-muted">Conversion Rate</small>
                        </div>
                    </div>
                    <div class="col-md-3 text-center">
                        <h4 class="text-info"><?php echo e($stats['total_leads'] ?? 0); ?></h4>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK-Station\freelance\workana\12\resources\views/client/capture-sites.blade.php ENDPATH**/ ?>