                ...
                <div class="position-sticky pt-3">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h4 class="navbar-brand mb-0">
                            ...
                            <?php echo e(\App\Models\SystemCustomization::getCompanyName()); ?>

                        </h4>
                        <small class="text-muted">Client Area</small>
                    </div>
                    ...
                    <ul class="nav flex-column">
                        ...
                        <?php if(auth()->user() && auth()->user()->hasActiveInvoice()): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('training.*') ? 'active' : ''); ?>" 
...
<?php /**PATH D:\WORK-Station\freelance\workana\affiliate\resources\views/layouts/client.blade.php ENDPATH**/ ?>