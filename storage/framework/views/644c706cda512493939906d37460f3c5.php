                                ...
                                <div class="col-md-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="recaptcha_enabled" name="recaptcha_enabled" 
                                               <?php echo e(($groups['recaptcha']->get('recaptcha_enabled')?->value ?? '0') == '1' ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="withdrawal_days" name="withdrawal_days" 
                                               value="<?php echo e($groups['financial']->get('withdrawal_days')?->value ?? ''); ?>" 
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="time" class="form-control" id="withdrawal_start_time" name="withdrawal_start_time" 
                                               value="<?php echo e($groups['financial']->get('withdrawal_start_time')?->value ?? ''); ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="time" class="form-control" id="withdrawal_end_time" name="withdrawal_end_time" 
                                               value="<?php echo e($groups['financial']->get('withdrawal_end_time')?->value ?? ''); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control" id="withdrawal_fee_type" name="withdrawal_fee_type">
                                            <option value="percentage" <?php echo e(($groups['financial']->get('withdrawal_fee_type')?->value ?? '') == 'percentage' ? 'selected' : ''); ?>>Percentage</option>
                                            <option value="fixed" <?php echo e(($groups['financial']->get('withdrawal_fee_type')?->value ?? '') == 'fixed' ? 'selected' : ''); ?>>Fixed Amount</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="withdrawal_fee_value" name="withdrawal_fee_value" 
                                               value="<?php echo e($groups['financial']->get('withdrawal_fee_value')?->value ?? ''); ?>" 
                                               placeholder="5.00">
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK-Station\freelance\workana\affiliate\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>