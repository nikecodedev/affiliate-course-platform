        ...
        <div class="tab-content" id="settingsTabsContent">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="logo-upload-container">
                                        <div class="current-logo mb-3" id="currentLogo">
                                            <?php if($groups['appearance']->get('logo_path')?->value): ?>
                                                <img src="<?php echo e(asset('storage/' . $groups['appearance']->get('logo_path')->value)); ?>" 
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="logo-upload-container">
                                        <div class="current-logo mb-3" id="currentDarkLogo">
                                            <?php if($groups['appearance']->get('logo_dark_path')?->value): ?>
                                                <img src="<?php echo e(asset('storage/' . $groups['appearance']->get('logo_dark_path')->value)); ?>" 
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="favicon-upload-container">
                                        <div class="current-favicon mb-3" id="currentFavicon">
                                            <?php if($groups['appearance']->get('favicon_path')?->value): ?>
                                                <img src="<?php echo e(asset('storage/' . $groups['appearance']->get('favicon_path')->value)); ?>" 
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="background-upload-container">
                                        <div class="current-background mb-3" id="currentBackground">
                                            <?php if($groups['appearance']->get('background_path')?->value): ?>
                                                <img src="<?php echo e(asset('storage/' . $groups['appearance']->get('background_path')->value)); ?>" 
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="site_description" name="settings[site_description]" rows="3"><?php echo e($groups['seo']->get('site_description')?->value ?? ''); ?></textarea>
            ...
            <div class="tab-pane fade" id="tracking" role="tabpanel">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('admin.settings.tracking')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="google_analytics_code" name="google_analytics_code" rows="4" 
                                          placeholder="<!-- Google Analytics Code -->"><?php echo e($groups['tracking']->get('google_analytics_code')?->value ?? ''); ?></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="google_tag_manager_code" name="google_tag_manager_code" rows="4" 
                                          placeholder="<!-- Google Tag Manager Code -->"><?php echo e($groups['tracking']->get('google_tag_manager_code')?->value ?? ''); ?></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="meta_pixel_code" name="meta_pixel_code" rows="4" 
                                          placeholder="<!-- Meta Pixel Code -->"><?php echo e($groups['tracking']->get('meta_pixel_code')?->value ?? ''); ?></textarea>
                            </div>
            ...
            <div class="tab-pane fade" id="recaptcha" role="tabpanel">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('admin.settings.recaptcha')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="recaptcha_enabled" name="recaptcha_enabled" 
                                           <?php echo e($groups['recaptcha']->get('recaptcha_enabled')?->value ? 'checked' : ''); ?>>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="recaptcha_site_key" name="recaptcha_site_key" 
                                           value="<?php echo e($groups['recaptcha']->get('recaptcha_site_key')?->value ?? ''); ?>" 
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="password" class="form-control" id="recaptcha_secret_key" name="recaptcha_secret_key" 
                                           value="<?php echo e($groups['recaptcha']->get('recaptcha_secret_key')?->value ?? ''); ?>" 
                                           placeholder="6LcXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX">
                                </div>
                            </div>
            ...
            <div class="tab-pane fade" id="financial" role="tabpanel">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('admin.settings.financial')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="withdrawal_days" name="withdrawal_days" 
                                           value="<?php echo e($groups['financial']->get('withdrawal_days')?->value ?? '1,2,3,4,5'); ?>" 
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="time" class="form-control" id="withdrawal_start_time" name="withdrawal_start_time" 
                                           value="<?php echo e($groups['financial']->get('withdrawal_start_time')?->value ?? '09:00'); ?>">
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="time" class="form-control" id="withdrawal_end_time" name="withdrawal_end_time" 
                                           value="<?php echo e($groups['financial']->get('withdrawal_end_time')?->value ?? '18:00'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="withdrawal_fee_type" name="withdrawal_fee_type">
                                        <option value="percentage" <?php echo e(($groups['financial']->get('withdrawal_fee_type')?->value ?? 'percentage') === 'percentage' ? 'selected' : ''); ?>>
                                            Percentage
                                        </option>
                                        <option value="fixed" <?php echo e(($groups['financial']->get('withdrawal_fee_type')?->value) === 'fixed' ? 'selected' : ''); ?>>
                                            Fixed Amount
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="withdrawal_fee_value" name="withdrawal_fee_value" 
                                           value="<?php echo e($groups['financial']->get('withdrawal_fee_value')?->value ?? '5.00'); ?>">
