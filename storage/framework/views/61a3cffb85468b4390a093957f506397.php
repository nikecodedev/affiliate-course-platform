    ...
    <div class="col-12 col-lg-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0"><i class="bi bi-pencil me-2"></i>Edit <?php echo e($user->name); ?></h5>
                <a href="<?php echo e(route('admin.users.show', $user)); ?>" class="btn btn-sm btn-secondary">Back</a>
            </div>
...
unset($__errorArgs, $__bag); ?>" name="document" value="<?php echo e(old('document', $user->document)); ?>">
...
unset($__errorArgs, $__bag); ?>" name="birth_date" value="<?php echo e(old('birth_date', optional($user->birth_date)->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>" name="is_active">
                                <option value="1" <?php echo e(old('is_active', $user->is_active) ? 'selected' : ''); ?>>Yes</option>
                                <option value="0" <?php echo e(!old('is_active', $user->is_active) ? 'selected' : ''); ?>>No</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" name="state" value="<?php echo e(old('state', $user->state)); ?>">
...
unset($__errorArgs, $__bag); ?>" name="zip_code" value="<?php echo e(old('zip_code', $user->zip_code)); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK-Station\freelance\workana\12\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>