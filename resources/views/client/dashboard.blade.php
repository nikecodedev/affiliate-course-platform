...
<div class="row">
    ...
    <div class="col-lg-4 mb-4">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="bi bi-book me-2"></i>Acesso aos Cursos
                </h5>
            </div>
            <div class="card-body text-center">
                <i class="bi bi-check-circle display-4 text-success mb-3"></i>
                <h6 class="mb-2">Acesso Liberado!</h6>
                <p class="text-muted mb-3">Você tem acesso completo à área de treinamentos.</p>
    ...
    <div class="col-lg-4 mb-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h6 class="mb-2">Acesso Restrito</h6>
                <p class="text-muted mb-3">Adquira um plano para ter acesso aos cursos.</p>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        <i class="bi bi-credit-card me-2"></i>Transações Recentes
                    </h5>
