...
<?php $__env->startSection('page-title', 'Withdrawal Requests'); ?>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="stat-number">R$ <?php echo e(number_format($client->available_balance, 2, ',', '.')); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="stat-number">R$ <?php echo e(number_format($client->total_withdrawals, 2, ',', '.')); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="stat-number"><?php echo e($client->withdrawalRequests()->pending()->count()); ?></div>
                    </div>
                    <div class="col-auto">
...
<div class="row">
    ...
    <div class="col-lg-4 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                <?php if($client->available_balance > 0): ?>
                    <form method="POST" action="<?php echo e(route('client.financial.withdrawals.store')); ?>" id="withdrawalForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('amount')); ?>" step="0.01" min="10" max="<?php echo e($client->available_balance); ?>" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-text">
                                Minimum: R$ 10.00 | Maximum: R$ <?php echo e(number_format($client->available_balance, 2, ',', '.')); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="cryptocurrency" <?php echo e(old('payment_method') === 'cryptocurrency' ? 'selected' : ''); ?>>Cryptocurrency</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="payment_details" id="payment_details" rows="3" class="form-control <?php $__errorArgs = ['payment_details'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                      placeholder="Enter your payment details (account number, PIX key, wallet address, etc.)" required><?php echo e(old('payment_details')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="cpf_password" id="cpf_password" class="form-control <?php $__errorArgs = ['cpf_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php else: ?>
                    <div class="text-center py-4">
                        ...
                        <a href="<?php echo e(route('client.dashboard')); ?>" class="btn btn-outline-primary">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <code class="text-primary">#<?php echo e($withdrawal->id); ?></code>
                                    </td>
                                    <td>
                                        <span class="fw-bold">R$ <?php echo e(number_format($withdrawal->amount, 2, ',', '.')); ?></span>
                                    </td>
                                    <td>
                                        <span class="text-muted">R$ <?php echo e(number_format($withdrawal->fee, 2, ',', '.')); ?></span>
                                    </td>
                                    <td>
                                        <span class="fw-bold text-success">R$ <?php echo e(number_format($withdrawal->net_amount, 2, ',', '.')); ?></span>
                                    </td>
                                    <td>
                                        <span class="badge bg-secondary"><?php echo e(ucfirst($withdrawal->payment_method)); ?></span>
                                    </td>
                                    <td>
                                        <span class="badge bg-<?php echo e($withdrawal->status === 'pending' ? 'warning' : ($withdrawal->status === 'approved' ? 'success' : ($withdrawal->status === 'rejected' ? 'danger' : 'info'))); ?>">
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span><?php echo e($withdrawal->created_at->format('d/m/Y')); ?></span>
                                    ...
                                    <td>
                                        <?php if($withdrawal->processed_at): ?>
                                            <div class="d-flex flex-column">
                                                <span><?php echo e($withdrawal->processed_at->format('d/m/Y')); ?></span>
                                                <small class="text-muted"><?php echo e($withdrawal->processed_at->format('H:i')); ?></small>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(route('client.financial.withdrawals.show', $withdrawal)); ?>" 
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-info" 
                                                    onclick="showRejectionReason('<?php echo e($withdrawal->rejection_reason); ?>')"
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <div>
                            <p class="text-muted mb-0">
                                Showing <?php echo e($withdrawals->firstItem()); ?> to <?php echo e($withdrawals->lastItem()); ?> 
                                of <?php echo e($withdrawals->total()); ?> results
                            </p>
                        </div>
                        <div>
...
<div class="modal fade" id="rejectionReasonModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <a href="<?php echo e(route('client.support.create')); ?>" class="btn btn-primary">Contact Support</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    document.getElementById('withdrawalForm').addEventListener('submit', function(e) {
        ...
        const availableBalance = <?php echo e($client->available_balance); ?>;
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK-Station\freelance\workana\affiliate\resources\views/client/financial/withdrawals.blade.php ENDPATH**/ ?>