        ...
        <div class="tab-content" id="settingsTabsContent">
            ...
            <div class="tab-pane fade" id="tracking" role="tabpanel">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <form id="trackingForm" action="{{ route('admin.settings.tracking.update') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="facebook_pixel_id" name="facebook_pixel_id" 
                                               value="{{ $groups['tracking']->get('facebook_pixel_id')?->value ?? '' }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="tiktok_pixel_id" name="tiktok_pixel_id" 
                                               value="{{ $groups['tracking']->get('tiktok_pixel_id')?->value ?? '' }}" 
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" id="custom_tracking_code" name="custom_tracking_code" rows="4"
                                                  placeholder="Enter custom tracking code (JavaScript, HTML, etc.)">{{ $groups['tracking']->get('custom_tracking_code')?->value ?? '' }}</textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="ms-2 badge {{ $groups['tracking']->get('google_analytics_id')?->value ? 'bg-success' : 'bg-secondary' }}">
                                                            {{ $groups['tracking']->get('google_analytics_id')?->value ? 'Active' : 'Inactive' }}
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="ms-2 badge {{ $groups['tracking']->get('google_tag_manager_id')?->value ? 'bg-success' : 'bg-secondary' }}">
                                                            {{ $groups['tracking']->get('google_tag_manager_id')?->value ? 'Active' : 'Inactive' }}
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="ms-2 badge {{ $groups['tracking']->get('meta_pixel_id')?->value ? 'bg-success' : 'bg-secondary' }}">
                                                            {{ $groups['tracking']->get('meta_pixel_id')?->value ? 'Active' : 'Inactive' }}
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (trackingForm) {
        trackingForm.addEventListener('submit', function(e) {
            ...
            fetch('{{ route("admin.settings.tracking.update") }}', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
