                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="border rounded p-3" style="background: linear-gradient(135deg, {{ \App\Models\SystemCustomization::getPrimaryColor() }} 0%, {{ \App\Models\SystemCustomization::getSecondaryColor() }} 100%); color: white; min-height: 200px;">
                                                    <div class="text-center">
                                                        <img id="preview-logo" src="{{ \App\Models\SystemCustomization::getLogoUrl() }}" alt="Logo" style="max-height: 40px; margin-bottom: 20px;">
                                                        <h4 id="preview-company">{{ \App\Models\SystemCustomization::getCompanyName() }}</h4>
