...
<?php $__env->startSection('title', 'System Customization'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="company_name" name="company_name" 
                                           value="<?php echo e(old('company_name', $customizations['company_name']->value ?? 'Your Platform')); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="company_email" name="company_email" 
                                           value="<?php echo e(old('company_email', $customizations['company_email']->value ?? 'contact@yourplatform.com')); ?>"
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="company_phone" name="company_phone" 
                                           value="<?php echo e(old('company_phone', $customizations['company_phone']->value ?? '+1 (555) 123-4567')); ?>"
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="company_address" name="company_address" rows="2"
                                              placeholder="Enter company address"><?php echo e(old('company_address', $customizations['company_address']->value ?? '123 Business St, City, State 12345')); ?></textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="color" class="form-control form-control-color" id="primary_color" name="primary_color" 
                                               value="<?php echo e(old('primary_color', $customizations['primary_color']->value ?? '#007bff')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="color" class="form-control form-control-color" id="secondary_color" name="secondary_color" 
                                               value="<?php echo e(old('secondary_color', $customizations['secondary_color']->value ?? '#6c757d')); ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="border rounded p-3" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; min-height: 200px;">
                                                    <div class="text-center">
                                                        <img id="preview-logo" src="<?php echo e(\App\Models\SystemCustomization::getLogoUrl()); ?>" alt="Logo" style="max-height: 40px; margin-bottom: 20px;">
                                                        <h4 id="preview-company"><?php echo e(old('company_name', $customizations['company_name']->value ?? 'Your Platform')); ?></h4>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="border rounded p-3">
                                                    <nav class="navbar navbar-expand-lg" style="background-color: <?php echo e(old('primary_color', $customizations['primary_color']->value ?? '#007bff')); ?>;">
                                                        <div class="container-fluid">
                                                            <img id="preview-header-logo" src="<?php echo e(\App\Models\SystemCustomization::getLogoUrl()); ?>" alt="Logo" style="max-height: 30px;">
                                                            <span class="navbar-brand text-white ms-2" id="preview-header-company"><?php echo e(old('company_name', $customizations['company_name']->value ?? 'Your Platform')); ?></span>
                                                        </div>
                                                    </nav>
                                                </div>
                                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="<?php echo e(route('admin.customization.reset')); ?>" method="POST" style="display: inline;">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK-Station\freelance\workana\12\resources\views/admin/customization/index.blade.php ENDPATH**/ ?>