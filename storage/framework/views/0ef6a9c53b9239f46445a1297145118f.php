    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="<?php echo e(route('admin.courses.modules.lessons.update', [$course, $module, $lesson])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="order" 
                                                   name="order" 
                                                   value="<?php echo e(old('order', $lesson->order)); ?>" 
                                                   min="1"
...
unset($__errorArgs, $__bag); ?>" 
                                                      ...
                                                      name="content" 
                                                      rows="6" 
                                                      placeholder="Enter lesson content (supports basic HTML)"><?php echo e(old('content', $lesson->content)); ?></textarea>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row text-center">
                                            <div class="col-6">
                                                <h5 class="text-primary"><?php echo e($lesson->order); ?></h5>
                                                <small class="text-muted">Order</small>
                                            </div>
                                            <div class="col-6">
                                                <h5 class="text-success"><?php echo e($lesson->created_at->format('M d')); ?></h5>
                                        ...
                                        <div class="mt-3">
                                            <small class="text-muted">
                                                <strong>Updated:</strong> <?php echo e($lesson->updated_at->format('M d, Y')); ?>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-1"><?php echo e($lesson->attachment_name); ?></h6>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK-Station\freelance\workana\12\resources\views/admin/lessons/edit.blade.php ENDPATH**/ ?>