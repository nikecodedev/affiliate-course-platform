            ...
            <div class="card">
                ...
                <form action="<?php echo e(route('admin.customization.update')); ?>" method="POST" enctype="multipart/form-data" id="customizationForm">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="border rounded p-3" style="background: linear-gradient(135deg, <?php echo e(\App\Models\SystemCustomization::getPrimaryColor()); ?> 0%, <?php echo e(\App\Models\SystemCustomization::getSecondaryColor()); ?> 100%); color: white; min-height: 200px;">
                                                    <div class="text-center">
                                                        ...
                                                        <h4 id="preview-company"><?php echo e(\App\Models\SystemCustomization::getCompanyName()); ?></h4>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-6">
                                <button type="button" class="btn btn-warning" onclick="resetCustomization()">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK-Station\freelance\workana\12\resources\views/admin/settings/customization.blade.php ENDPATH**/ ?>