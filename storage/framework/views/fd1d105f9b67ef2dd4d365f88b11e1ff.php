    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="<?php echo e(route('admin.courses.modules.update', [$course, $module])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="order" 
                                                   name="order" 
                                                   value="<?php echo e(old('order', $module->order)); ?>" 
                                                   min="1"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row text-center">
                                            <div class="col-6">
                                                <h5 class="text-primary"><?php echo e($module->lessons->count()); ?></h5>
                                                <small class="text-muted">Lessons</small>
                                            </div>
                                            <div class="col-6">
                                                <h5 class="text-success"><?php echo e($module->order); ?></h5>
                                        ...
                                        <div class="mt-3">
                                            <small class="text-muted">
                                                <strong>Created:</strong> <?php echo e($module->created_at->format('M d, Y')); ?><br>
                                                <strong>Updated:</strong> <?php echo e($module->updated_at->format('M d, Y')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK-Station\freelance\workana\12\resources\views/admin/modules/edit.blade.php ENDPATH**/ ?>